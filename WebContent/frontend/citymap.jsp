...
<body>
	...
	<div id="pannel2">
		<div id="pannel2_1_1">
			从目标出发到达星星 期望时间<input type="tel" id="toStar" size="20" value=3600 style="width:13%; font-family:微软雅黑;"/>秒
		</div>
		<div id="pannel2_1_2" onclick=switchDisPlay(6);>
			
		</div>
		<div id="pannel2_2_1">
			从星星出发到达目标 期望时间<input type="tel" id="fromStar" size="20" value=3600 style="width:13%; font-family:微软雅黑;"/>秒
		</div>
	...
	<script>
		...
		function updateClock(){
			...
			clock.innerHTML='耗时:  ' + parseInt((nowTime - taskCommitTime)/1000) + '  分析速度:  '  + processedSpeed.toFixed(1)+' 点每秒';
		}
